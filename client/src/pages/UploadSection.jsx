...
const UploadSection = () => {
  ...
  const handleImageChange = (e) => {
    ...
    if (files.every(image => image.type === "image/jpeg" || image.type === "image/png")) {
      ...
      <main className="create-container">
        <form className="post-form">
          <div className="post-top">
            ...
            <textarea rows="4" placeholder="Share something..." onChange={(e)=>setContext(e.target.value)}></textarea>
          </div>
          ...
          <button type="submit" className="upload-btn" onClick={handleSelectContext}>
            Upload
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
